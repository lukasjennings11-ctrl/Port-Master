---
name: game-factory
description: Build, playtest, polish, and ship a new HTML5 canvas game for Port Boss. Use when scouting a new game concept, scaffolding a game, implementing gameplay, polishing game feel, or preparing a portal submission package.
---

# Game Factory Skill

You are building HTML5 canvas games for the Port Boss arcade portal. Ten games already exist — fuse, stack, orbit, match3, bubble, idle, io, runner, equate, td. Every new game must fit the factory pattern: zero dependencies, mobile-first, ships as a static folder, integrates juice.js + retention.js.
...
<head>
  ...
  <meta property="og:title" content="<Title> — Port Boss" />
  <meta property="og:description" content="<same as description>" />
  <title><Title> — <genre> · Port Boss</title>
...
A Port Boss game is ready to ship when:
