# Community feedback drafts (Phase 13e)

## Reddit — r/incremental_games (post on "Feedback Friday" thread, or as a standalone
...
**Play (60 seconds to first build):** https://lukasjennings11-ctrl.github.io/Port-Master/games/harbor/

I'd genuinely value blunt answers to three questions:
1. **Pacing:** where did it drag first — minute 5, 15, or 30? What were you waiting on?
2. **Clarity:** which system did you NOT understand or not notice existed?
3. **The quit moment:** when you closed the tab, what was the reason?

Everything's tuned by automated balance bots so far — you're the first real captains. I'll
patch fast based on this thread. Thanks! ⚓

*(Mobile Safari players especially wanted — that's my least-tested platform.)*
...
### Posting notes (for you)
- Reddit converts best Fri–Sun; answer every comment in the first 3 hours — the sub rewards
  responsive devs and buries silent ones.
- Expect blunt/harsh top comments; the gold is usually in them. Forward the thread to me and
  I'll turn it into a patch list within a session.
- Don't post both platforms the same day — Reddit first (bigger idle audience), itch.io after
  the first patch from Reddit feedback (so itch reviews hit a better build).
